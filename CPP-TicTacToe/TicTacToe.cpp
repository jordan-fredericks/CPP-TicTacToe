...
void TicTacToe::Victor(char marker) const
{
...
//The current player places their marker on the board in an unnocupied space, then the active player changes and the turn counter goes up
